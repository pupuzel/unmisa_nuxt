...
export default {
  ...
  methods: {
    login(type){
      if(type === 'kakao'){
        window.location.href = 'https://kauth.kakao.com/oauth/authorize?client_id=2cb8c9ef012ae465cdbfbf9a91d2d58f&redirect_uri=http://127.0.0.1:3000/auth/callback/kakao&response_type=code&prompt=none';
      }else if(type === 'naver'){
        window.location.href = 'https://nid.naver.com/oauth2.0/authorize?client_id=0dChYllU1ncvhUyN3E8R&redirect_uri=http://127.0.0.1:3000/auth/callback/naver&response_type=code';
      }else if(type === 'google'){
